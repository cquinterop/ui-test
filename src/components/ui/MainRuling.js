          ...
          <Card className="text-white bg-transparent rounded-0 my-5 p-0">
            ...
            <CardFooter className="border-0 p-0">
              <ButtonGroup className="col-12 p-0 hero__vote">
                <Button className="border-0 rounded-0 hero__vote hero__vote--up size-2" aria-label="Thumb up">
                  <FontAwesomeIcon icon={faThumbsUp} />
                </Button>
                <Button className="border-0 rounded-0 hero__vote hero__vote--down size-2 flip-horizontal" aria-label="Thumb down">
